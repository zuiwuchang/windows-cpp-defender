...
bool service::load()
{
    ...
    try
    {
        ...
        KING_DEBUG("service bin  : "<<utf::wchar_to_char(_bin))
        KING_DEBUG("service name : "<<utf::wchar_to_char(_name))
        KING_DEBUG("service show : "<<utf::wchar_to_char(_show))
        KING_DEBUG("service desc : "<<utf::wchar_to_char(_description))
        KING_DEBUG("service auto : "<<_auto)
...
bool service::run()
{
    try
    {
        _thread = boost::make_shared<boost::thread>(boost::bind(work_thread,_directory,_bin));
        return true;
    }
    catch(...)
    {
